...
write_csv('manuscript/submission/DataS1_Gsp1_Reads_Scores_Bins.csv')
...
bind_rows(df_ddg_3m1i, df_ddg_3gj0) %>% 
    ...
    filter(mutation!='NA') %>% 
    write_csv('manuscript/submission/DataS2_Gsp1_DDG.csv')
...
read_csv('data/ddg/ddg_benchmark_dataset.csv', col_types=cols()) %>% 
    ...
    write_csv('manuscript/submission/DataS3_Benchmark_DDG.csv')
