...
# n. of toxic mutations is 1188 (these DON'T INCLUDE position 220, the STOP)
m <- df %>% 
...
ggsave('figures/FigS3/FigS3_independent_dist.pdf', width = 3.6, height = 2.5)
