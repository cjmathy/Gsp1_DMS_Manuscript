...
df <-
    ...
    mutate(is_hydrophobic = ifelse(aa_from %in% hydrophobics, 'Mutations at hydrophobics', 'Mutations at other AA'))
...
ggsave('figures/FigS4/FigS4B_scatter.pdf', width=4.5, height = 2.6)
