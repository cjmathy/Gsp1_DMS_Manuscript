...
pdf('figures/FigS4/FigS4B_ddG_outliers_heatmap.pdf', height = 3, width = 3)
draw(hm)
dev.off()
...
df_to_plot %>% 
    ...
    xlab('Gsp1 sequence position') + ylab('Number of WT-like mutations predicted as\ndestabilizing by Rosetta (ddG > 3)'a) +
    theme_custom

ggsave('figures/FigS4/FigS4D_ddG_outliers_position.pdf', width=4, height = 3)
