...
df.to_csv('3m1i_gsp1_ddg_with_scores.csv', index=False, float_format='%g')

# also write a simpler file of just ddg's
df[['mutation','ddg']].drop_duplicates().to_csv('3m1i_gsp1_ddg.csv', index=False, float_format='%g')
